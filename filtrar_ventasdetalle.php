...
if (isset($_POST['filtrar'])) {
  ...
  $query = "SELECT LINEAS.FECHA AS FECHA, PRODUCTS2.NAME AS NOMBRE, CONCAT('$',FORMAT(LINEAS.PRICESELL, 2)) AS IMPORTE, LINEAS.USUARIO AS SUCURSAL FROM LINEAS INNER JOIN PRODUCTS2 ON LINEAS.PRODUCT=PRODUCTS2.ID"
  ." WHERE 1=1";
  ...
  $query .= " ORDER BY PRODUCTS2.ID, LINEAS.USUARIO";
